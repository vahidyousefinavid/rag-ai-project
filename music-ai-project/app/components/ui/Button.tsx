...
export function Button({
  ...
  const variants: Record<Variant, React.CSSProperties> = {
    primary: {
      background: isDisabled ? 'rgba(168,85,247,0.35)' : `linear-gradient(135deg, ${C.purple}, ${C.purpleDark})`,
      color: 'white',
      border: 'none',
      boxShadow: isDisabled ? 'none' : `0 6px 20px ${C.purpleGlow}`,
    },
    secondary: {
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? 'rgba(168,85,247,0.14)' : C.surface2,
        border: `1px solid ${active ? C.purple + '40' : C.border}`,
